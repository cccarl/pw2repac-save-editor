...
pub fn int_to_mission_level(id: usize) -> String {
    match id {
        ...
        10 | 11 => "Clyde's Frog",
        12..=14 => "B-Doing Woods",
        15..=17 => "Treewood Forest",
        18..=20 => "Butane Pain",
        21 | 22 => "Inky's Whimsy",
        23..=25 => "Ice River Run",
        26..=28 => "Avalanche Alley",
        29..=31 => "Blade Mountain",
        32 | 33 => "Pinky's Revenge",
        34..=36 => "Into The Volcano!",
        37..=39 => "Volcanic Panic",
        40..=42 => "Magma Opus",
        43 | 44 => "Blinky in the Caldera",
        45..=47 => "Scuba Duba",
        48..=50 => "Shark Attack",
        51..=53 => "Yellow Pac-Marine",
        54 | 55 => "Whale on a Sub",
        56..=58 => "Haunted Boardwalk",
        59..=61 => "Night Crawling",
        62..=64 => "Ghost Bayou",
        65 | 66 => "Spooky",
        67..=69 => "Deadly Poisonous Meadows",
        70 | 71 => "A Long Poisonous Tongue",
        72..=74 => "Harsh Harsh Winds",
        75 | 76 => "Hunter Of Darkness",
        77..=79 => "Pro Thunder Skater",
        80 | 81 => "Boom! Boom! Clap!",
        82..=84 => "Hot! Fire Trouble",
        85 | 86 => "Burning Hot Beats",
        87..=89 => "Sharks Everywhere",
        90 | 91 => "Pac-Marine Battle!",
        92..=94 => "Clumsy Bayou",
        95 | 96 => "Legendary Story",
        97 | 98 => "Flying Dark Shadow",
        99..=101 => "Rolling Around On the Island",
        102..=104 => "Supersonic Tricky Railroad",
